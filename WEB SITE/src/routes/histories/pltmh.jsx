...
import PLTMHTableHistories from "~/partials/histories/pltmh/pltmh.table.histories";
import PLTMHGraphicHistories from "~/partials/histories/pltmh/pltmh.graphic.histories";
...
export default function PLTMHHistories() {

    const group = SOCKET_TAG.pltmh
            ...
            >
                {
                    model() === VIEW_MODEL.table.value
                        ? <PLTMHTableHistories model={model()} periode={periode()} rows={rows()} />
                        : <PLTMHGraphicHistories model={model()} periode={periode()} rows={rows()} />
                }
            </WrapperHistories>
        </ContentLayout>
    )
